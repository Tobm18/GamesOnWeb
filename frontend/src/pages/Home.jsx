  ...
  const games = [
    {
      ...
      title: "Keep It Alive",
      description:
        "Survivez le plus longtemps possible, mais attention aux obstacles !",
      img: "/images/keep-it-alive.png",
    },
    {
      id: "miage-surfers",
      title: "Miage Surfers",
      description:
        "Courez à l'infini sur 3 lanes, esquivez les obstacles et collectez les power-ups !",
      img: "/images/miage-surfers.png",
    },
    {
      id: "puissance4",
      title: "Puissance 4",
      description:
        "Affrontez le bot en 5 niveaux de difficulté. Alignez 4 pions pour gagner !",
        ...
        <section className="introduction">
          <div className="welcome-content">
            ...
            <p className="welcome-subtitle">
              Découvrez les trois jeux des Tom's (et Francesca) pour l'édition
              de cette année.
            </p>
          </div>
          <div
            ...
            <div className="carousel-wrapper">
              <div className="carousel">
                {games.map((game, index) => {
                  const position =
                    (index - currentCard + games.length) % games.length;
                  const gameData = allScores[game.id] || {
                    topScore: null,
                    personalScore: null,
                  };
                  ...
                  const isPlayerTop =
                    ...
                    topScore &&
                    personalScore &&
                    topScore.playerName === user.username;
                        ...
                        <div className="game-score">
                          ...
                          {showPersonal && (
                            <div className="personal-score-link">
                              Ton record :{" "}
                              <span>{personalScore.score} pts</span>
                            </div>
                          )}
                        </div>
                        <h3>{game.title}</h3>
